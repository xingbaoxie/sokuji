...
export const INVOKE_CHANNELS = [
  ...
  'native-host:stop',
  'native-host:status',
  // Recording transcription desktop bridge
  ...
  'recording:get-job',
  'recording:get-job-preview',
  'recording:get-transcript-result',
  'recording:get-translation-result',
  'recording:get-summary-result',
  'recording:list-jobs',
  ...
  'recording:profile-save-credential',
  'recording:profile-clear-credential',
  'recording:runtime-status',
  'recording:aliyun-profile-status',
