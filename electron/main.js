...
app.setName('sokuji');
// Keep source-tree runs isolated from the packaged app. Without this, both
// processes use "Application Support/Sokuji", which lets development profiles
// and credentials leak into a user's installed client (and vice versa).
if (!app.isPackaged) {
  app.setPath('userData', path.join(app.getPath('appData'), 'Sokuji-dev'));
}
