      ...
      electron({
        main: {
          ...
          entry: {
            ...
            // Recording jobs use CommonJS sibling requires in the Main process.
            // Keep every node in that runtime dependency closure as an explicit
            // entry: sibling imports are deliberately externalized below to
            // preserve their CJS exports and circular-dependency behaviour.
            ...
            'recording-summary-templates': 'electron/recording-summary-templates.js',
            'recording-audio-protocol': 'electron/recording-audio-protocol.js',
            'recording-runtime-client': 'electron/recording-runtime-client.js',
            'recording-provider-registry': 'electron/recording-provider-registry.js',
            'aliyun-cloud-client': 'electron/aliyun-cloud-client.js',
