# Vendored verbatim from MOSS-TTS-Nano's `ort_cpu_runtime.py`.
#   Source: https://github.com/OpenMOSS/MOSS-TTS-Nano
#   Commit: 31f42bae0a181849864c7ee39e8b88990909065f
#   File:   ort_cpu_runtime.py
# This is the pure-onnxruntime core (imports only onnxruntime + numpy, NO torch).
# Kept as-is so it tracks upstream; the torch/torchaudio/WeTextProcessing wrapper
# (onnx_tts_runtime.py) is deliberately NOT vendored — MossOnnxTtsBackend in
# sokuji_sidecar.tts_backends ports its torch-free ORT stitching instead.
